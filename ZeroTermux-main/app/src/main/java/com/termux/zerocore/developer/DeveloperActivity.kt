...
class DeveloperActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.create_files).setOnClickListener {
            ...
            try {
                FileUtils.createDirectoryFile("/data/data/com.dshcli/files1/")
                val pair = Pair<String, String>("t.txt", "/data/data/com.dshcli/files/t.txt")
        ...
        ZipUtils.toZip("/data/data/com.dshcli/files/", "/data/data/com.dshcli/files.zip", object : ZipNameListener{
        ...
        findViewById<Button>(R.id.test_unzip).setOnClickListener {
           ...
           ZipUtils.unZip(File("/data/data/com.dshcli/files.zip"), "/data/data/com.dshcli/files1/", object : ZipNameListener{
               override fun zip(FileName: String?, size: Int, position: Int) {
        ...
        findViewById<Button>(R.id.test1).setOnClickListener {
            try {
                val file =
                    File("/data/data/com.dshcli/files/home/ubuntu-in-termux/ubuntu-fs/etc/init.d/procps")
        ...
        findViewById<Button>(R.id.test_rlj).setOnClickListener {
            ...
            Os.symlink("/storage/emulated/0", "/data/data/com.dshcli/files1/files/sdcard")
        }
