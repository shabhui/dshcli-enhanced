...
public object CodeString {
    ...
    public var runDocker = "pkg update && pkg install tsu wget -y && cd ~ && chmod 777 check-config.sh && sed -i '1s_.*_#!/data/data/com.dshcli/files/usr/bin/bash_' check-config.sh && sudo ./check-config.sh\n"
