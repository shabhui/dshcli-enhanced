...
shell_Android() {
echo ">>>>>>>>>>>>>>>>>shell_Android"
chmod 777 /data/data/com.dshcli/files/home/.timerdir/shell_timer.sh
./data/data/com.dshcli/files/home/.timerdir/shell_timer.sh
}
...
shell_chmod() {
    chmod 777 /data/data/com.dshcli/files/execTermuxEnv.sh
}
